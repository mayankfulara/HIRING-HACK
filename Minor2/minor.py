...
def perdict_person():
    ...
    lab=Label(top, text="Basic Information", foreground='orange', bg='black', font=titleFont, pady=10).pack()
    ...
    l1=Label(top, text="Applicant Name", foreground='white', bg='purple').place(x=70, y=130)
    l2=Label(top, text="Age", foreground='white', bg='purple').place(x=70, y=160)
    l3=Label(top, text="Gender", foreground='white', bg='purple').place(x=70, y=190)
    l4=Label(top, text="Upload Resume", foreground='white', bg='purple').place(x=70, y=220)
    l5=Label(top, text="Enjoy New Experience or thing(Openness)", foreground='white', bg='purple').place(x=70, y=250)
    l6=Label(top, text="How Offen You Feel Negativity(Neuroticism)", foreground='white', bg='purple').place(x=70, y=280)
    l7=Label(top, text="Wishing to do one's work well and thoroughly(Conscientiousness)", foreground='white', bg='purple').place(x=70, y=310)
    l8=Label(top, text="How much would you like work with your peers(Agreeableness)", foreground='white', bg='purple').place(x=70, y=340)
    l9=Label(top, text="How outgoing and social interaction you like(Extraversion)", foreground='white', bg='purple').place(x=70, y=370)
    ...
    submitBtn.place(x=375, y=450, width=200)
...
def OpenFile(b4):
    global loc;
    name = filedialog.askopenfilename(initialdir="D:\Minor2/",
...
if __name__ == "__main__":
    ...
    root.title("GIRING HACK")
    titleFont = font.Font(family='Helvetica',size=25, weight='bold')
    homeBtnFont = font.Font(size=12, weight='bold')
    lab=Label(root, text="HIRING HACK", bg='white', font=titleFont, pady=30).pack()
    b2=Button(root, padx=4, pady=4, width=30, text="Predict Personality", bg='red', foreground='white', bd=1, font=homeBtnFont, command=perdict_person).place(relx=0.5, rely=0.5, anchor=CENTER)
    root.mainloop()